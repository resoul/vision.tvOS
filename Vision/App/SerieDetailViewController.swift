...
final class SerieDetailViewController: BaseDetailViewController {
    ...
    private func playEpisode(folder: _FilmixPlayerFolder, seasonIndex: Int, episodeIndex: Int) {
    ...
    private func showEpisodeQualityFallback(streams: [String: String],
    ...
    private func finishPlay(url: String, quality: String, folder: _FilmixPlayerFolder,
                             seasonIndex: Int, episodeIndex: Int, studio: String) {
        ...
        // Следующий эпизод
        playerVC.onRequestNextEpisode = { [weak self] in
            self?.playNextEpisode(afterSeasonIndex: seasonIndex, episodeIndex: episodeIndex)
        }
